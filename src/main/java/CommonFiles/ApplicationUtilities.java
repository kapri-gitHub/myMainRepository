...
import propertyfilelib.PropertyLib;
//Do Not Delete This Class File.
//This Class File contains all the necessary codes of selenium; this file is provided
// by Piyush Sir. 
public  class ApplicationUtilities extends BaseLibrary 
  {
	...
	public void openIB(WebDriver driver) 
	{
		try 
		{
			...
			String StrURLIB = PropertyLib.getPropertyValue("urlIB");
			driver.get(StrURLIB);
		} 
		catch (Exception e) 
		{
	 ...
	 /*Below method will only hover any element; will not click it*/
		public void mouseHover(WebElement ele) 
		{
	       ...
	       act.moveToElement(ele).perform(); // .perform() is used for hover only.
		} // .build().perform() is used for hover and click. check the below method.
